...
function doOnReady(){
    ...
    questionButton.addEventListener('click',() => {
        ...
        if (isTheFirstAnswer()) {            
            fillCurtainBlack();
            displayAnswer(randomAnswerText);
        }
...
function isTheFirstAnswer(){
    return !Boolean(document.getElementById('answerOnCurtain'));
}
...
function displayAnswer(randomAnswerText){
    ...
    let answerOnCurtain = document.createElementNS("http://www.w3.org/2000/svg", "text");
        ...
        answerOnCurtain.setAttributeNS(null, 'font-size', '180%');
